		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapuidemowalkthrough-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapuidemowalkthrough-display": {
								"semanticObject": "sapuidemowalkthrough",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui.demo.walkthrough",
									"url": sap.ui.require.toUrl("sap/ui/demo/walkthrough")
								}
							}
						}
					}
